...
const Footer = () => {
  return (
    <div className="w-full mt-24 bg-gradient-to-r from-purple-200 via-purple-400 to-purple-800 text-black-300 py-y px-2">
      <div className="max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8">
        ...
        <div>
          <h6 className="font-bold uppercase pt-2">Technologies Used</h6>
          <ul>
